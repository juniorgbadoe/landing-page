...
function Prices() {
  return (
        <div className="relative isolate bg-white dark:bg-gray-950 scheme-light dark:scheme-dark">
    ...
    {tiers.map((tier, tierIdx) => (
      <div
        ...
        className={classNames(
          tier.featured ? 'relative bg-gray-800 dark:bg-gray-800' : 'bg-white/2.5 dark:bg-white/5 sm:mx-8 lg:mx-0',
          tier.featured
            ? ''
            : tierIdx === 0
      ...
      >
        ...
        <p className="mt-4 flex items-baseline gap-x-2">
          <span
            className={classNames(
              'text-5xl font-semibold tracking-tight text-gray-900 dark:text-white',
            )}
          >
            {tier.priceMonthly}
          </span>
