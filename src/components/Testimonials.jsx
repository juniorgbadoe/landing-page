...
function Testimonials() {
  return (
    <section className="relative isolate overflow-hidden bg-gray-100 dark:bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] 
        bg-white dark:bg-gray-900 shadow-xl ring-1 ring-gray-200 dark:ring-white/10 
